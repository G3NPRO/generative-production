...
- [`prompting-principles.md`](prompting-principles.md) — the universal skill.
- [`iteration-and-selection.md`](iteration-and-selection.md) — how to work with the fact that the tool gives you many candidates.
- [`tracking-your-work.md`](tracking-your-work.md) — staying reproducible across months.
